...
<head>
    ...
    <title>HoTeru | A propos de nous</title>
...
<body>
    ...
    <nav style="margin-bottom: 20px;">
        ...
        <div class="main-navlinks">
            ...
            <div class="navlinks">
                ...
                <a href="./about.php" class="nav-link" arial-current="page" style="color: #ff9677;">A propos</a>
            </div>
        </div>
    ...
    <div class=" container d-flex align-items-center justify-content-center textou" style="height: 85vh;">
        <div class="d-flex flex-column align-items-center">
            <img src="../im/favicon.png" style="width: 250px;" alt="">
            <h2 class="fw-normal" style="color: #550032;">HoTeru Website</h2>
            <p>by</p>
            <p>VCorp</p>
        </div>
    </div>
