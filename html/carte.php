...
<body>
    ...
    <nav style="margin-bottom: 20px;">
        ...
        <div class="main-navlinks">
            ...
            <div class="navlinks">
                ...
                <a href="./carte.php" class="nav-link" arial-current="page" style="color: #ff9677;">Carte</a>
    ...
    <div class="container px-4" id="hanging-icons">
        ...
        <form class="d-flex" role="search">
            <input class="form-control me-3" type="search" placeholder="Rechercher" aria-label="Rechercher"
                _mstplaceholder="74607" _msthash="17" _mstaria-label="74607">
            <button class="btn" style="background-color: #550032; color: white;" type="submit" _msttexthash="154362"
                _msthash="18">Rechercher</button>
        </form>
        <div id="carte">

        </div>
    </div>
    <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCsvc9EGGNWpZSs2wDj-1TbuXAgqlLPqsU&callback=initMap"></script>
