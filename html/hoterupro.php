...
<head>
    ...
    <link rel="stylesheet" href="../css/hoterupro.css">
...
<body>
    ...
    <div class="container px-4 conte" id="hanging-icons">
        <h2 class="pb-2 border-bottom" _msttexthash="342264" _msthash="18">Rejoignez la grande famille HoTeru...</h2>
        <h5 style="font-weight: lighter; font-size: 20px;" _msthash="19">
            Inscrivez-vous et gérez votre hôtel grâce à HoTeru Pro <br>
            Quels sont vos avantages ?
        </h5>

        <div class="d-flex flex-column g-4 py-2 divi">
            <div>
                <h3 style="font-size: 16px; background-color: #EDE5ED; padding: 20px 50px; border-radius: 10px;"
                    _msttexthash="208169" _msthash="19">Être lister sur internet</h3>
            </div>
            <div>
                <h3 style="font-size: 16px; background-color: #EBFAEF; padding: 20px 50px; border-radius: 10px;"
                    _msttexthash="208169" _msthash="22">Augmenter votre profit</h3>
            </div>
            <div>
                <h3 style="font-size: 16px; background-color: #FFF4F1; padding: 20px 50px; border-radius: 10px;"
                    _msttexthash="208169" _msthash="25">Augmenter votre clientèle</h3>
            </div>
        </div>
        <div class="col">
            <div class="row g-0 p-4 overflow-hidden flex-md-row mb-4 h-md-250 position-relative didi">
                <div class="col p-4 d-flex flex-column position-static">
                    <h3 class="mb-0">HoTeru Pro</h3>
                    <p class="card-text mb-4">Gérez Votre Hôtel Avec HoTeru Pro</p>
                    <a href="./register-hot-pro/register-hot.php"
                        class="icon-link gap-4 icon-link-hover stretched-link didia">
                        <label>J'inscris mon hôtel</label>
                        <i class="bi fa-regular fa-solid fa-chevron-right fa-bounce"></i>
                    </a>
                </div>
                <div class="col-auto d-none d-lg-block">
                    <img src="../im/hoteruic.png" style="width: 200px;">
                </div>
            </div>
        </div>
    </div>
...
<?php
    ...
    $resultat = ['status' => 'Fail' , 'msg' => 'impossible de recuperer la ville'];
    
    if(isset($nom_ville)){
        $id_ville = getFieldByItem($ville_table,'id','nom_ville',$nom_ville);
        $resultat ['data'] = getAllByItem($qt_table, 'ville_id',$id_ville);
